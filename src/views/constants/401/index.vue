<template>
  <div :class="n.b()">
    <h2 :class="n.e('code')">401</h2>
    <p :class="n.e('describe')">抱歉！您<em>没有权限</em>访问该页面...</p>
    <p :class="n.e('suggest')">如有不满请联系您的领导</p>
    <p :class="n.e('timeout')">
...
const n = useNamespace('unauthorized')
