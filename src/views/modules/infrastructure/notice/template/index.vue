...
import { pageApi, deleteApi, setStatusApi, exportApi } from '@/api/notice-template'

defineOptions({
  name: 'InfrastructureNoticeTemplate'
})
    ...
    <template #header>
      <el-form ref="refForm" :inline="true" @keyup.enter="reacquireHandle">
        ...
        <el-form-item>
          ...
          <el-button
            v-permission="'noticeTemplate:create'"
            type="primary"
            @click="addEditHandle()">新增</el-button>
          <el-button
            v-permission="'noticeTemplate:delete'"
            type="danger"
            @click="deleteHandle()"
            :disabled="selection.length <= 0">批量删除</el-button>
          <el-button v-repeat v-permission="'noticeTemplate:export'" @click="exportHandle">导出</el-button>
        </el-form-item>
      </el-form>
    </template>
    <template #default>
      <el-table
        ...
        <el-table-column
          ...
          <template v-slot="{ row }">
            <el-button
              v-permission="'noticeTemplate:update'"
              type="primary"
              link
