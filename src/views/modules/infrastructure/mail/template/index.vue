...
import { pageApi, deleteApi, setStatusApi, exportApi } from '@/api/mail-template'

defineOptions({
  name: 'InfrastructureMailTemplate'
})
    ...
    <template #header>
      <el-form ref="refForm" :inline="true" @keyup.enter="reacquireHandle()">
        ...
        <el-form-item>
          ...
          <el-button v-repeat v-permission="'mailTemplate:export'" @click="exportHandle">导出</el-button>
        </el-form-item>
      </el-form>
    </template>
    <template #default>
