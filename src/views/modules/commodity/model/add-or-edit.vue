 ...
 * @LastEditTime: 2021-03-03 10:29:46
-->
<template>
  <el-dialog
    width="400px"
  ...
  >
    ...
    >
      <el-form-item label="模型名称" prop="name">
        <el-input v-model="form.name" placeholder="模型名称" maxlength="100"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
...
import { info, save, edit } from '@API/commodity/model/index'
