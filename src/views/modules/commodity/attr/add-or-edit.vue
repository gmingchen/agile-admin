 ...
 * @LastEditTime: 2021-03-03 10:52:52
-->
<template>
  <el-dialog
    width="400px"
  ...
  >
    ...
    >
      <el-form-item label="参数名称" prop="name">
        <el-input v-model="form.name" placeholder="参数名称" maxlength="100"></el-input>
      </el-form-item>
      <el-form-item label="参数列表" prop="vals">
        <el-input type="textarea" v-model="form.vals" placeholder="参数列表" maxlength="1000"></el-input>
        <span>多个可选值使用逗号分隔</span>
      </el-form-item>
...
import { info, save, edit } from '@API/commodity/attr/index'
...
export default class extends Vue {
  ...
  protected rules = {
    ...
    vals: [{ required: true, message: '参数列表不能为空', trigger: 'blur' }]
  }
