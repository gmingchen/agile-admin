 ...
 * @LastEditTime: 2021-03-02 15:05:31
-->
<template>
  <div class="base-container">
    <el-form ref="formRef" :inline="true" @keyup.enter="getList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:role:save')" type="primary" @click="addOrEditHandle()">新增</el-button>
        <el-button v-if="isAuth('sys:role:delete')" type="danger" @click="delHandle()" :disabled="selection.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      class="base-table"
    ...
    >
      ...
      <el-table-column header-align="center" align="center" label="角色名称" prop="name" />
      ...
      <el-table-column header-align="center" align="center" width="150" label="操作" fixed="right">
        <template v-slot="scope">
          <el-button v-if="isAuth('sys:role:update')" type="text" size="small" @click="addOrEditHandle(scope.row.id)">修改</el-button>
          <el-button v-if="isAuth('sys:role:delete')" type="text" size="small" @click="delHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
import { pageList, del } from '@API/system/role/index'
